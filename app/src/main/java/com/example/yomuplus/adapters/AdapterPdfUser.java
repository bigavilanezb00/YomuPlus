...
import com.example.yomuplus.databinding.RowPdfUserBinding;
import com.example.yomuplus.filters.FilterPdfUser;
...
public class AdapterPdfUser extends RecyclerView.Adapter<AdapterPdfUser.HolderPdfUser> implements Filterable {
    ...
    public int getItemCount() {
        return pdfArrayList.size();// devuelve el tamaño de la lista
    }
