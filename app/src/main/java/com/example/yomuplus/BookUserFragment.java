...
import com.example.yomuplus.adapters.AdapterPdfUser;
import com.example.yomuplus.databinding.FragmentBookUserBinding;
...
public class BookUserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(TAG, "onCreateView: Categoria: "+category);
        if (category.equals("Todos")) {
            //carga todos los libros
            loadAllBooks();
        } else if (category.equals("Más visto")) {
            //carga los libros mas vistos
            loadMostViewedDownloadedBooks("viewsCount");
        } else if (category.equals("Más descargado")) {
            //carga los libros mas descargados
            loadMostViewedDownloadedBooks("downloadsCount");
        } else {
            //carga la categoria elegida
    ...
    private void loadMostViewedDownloadedBooks(String orderBy) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Libros");
        ref.orderByChild(orderBy).limitToLast(10) // carga los más vistos o descargados
